...
function loadAutocompleteData(x) {
  var dfd = jQuery.Deferred();

  $.getJSON("http://gd.geobytes.com/AutoCompleteCity?&q=" + x + "&callback=?", function(result) {
  ...
  // });
      ...
      function autocomplete(inp) {
          ...
          inp.addEventListener("input", function(e) {
              ...
              var that = this;
              loadAutocompleteData(this.value)
                  .then(function(data) {
